...
export function FarmerDashboard() {
  ...
  const handleExportReport = () => {
    toast({
      ...
      description: "Your farmer report is being generated and will be available shortly.",
    });
  };
  ...
  const handleLogChemicalUse = () => {
    router.push("/farm-management"); // Or a more specific page if it exists
  };

  const handleSyncSensorData = () => {
    router.push("/farm-management"); // Or a more specific page
  };
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
        <h1 className="text-3xl font-bold tracking-tight font-headline text-foreground">Farmer Dashboard</h1>
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        <Card className="lg:col-span-2 shadow-lg hover:shadow-xl transition-shadow duration-300 bg-card">
          <CardHeader>
            <CardTitle className="font-headline text-card-foreground">Recent Farm Activity</CardTitle>
          ...
          <CardFooter>
            <Button variant="outline" size="sm" onClick={() => router.push('/farm-management')}>View All Activity</Button>
          </CardFooter>
        </Card>

        <Card className="shadow-lg hover:shadow-xl transition-shadow duration-300 bg-card">
          <CardHeader>
            <CardTitle className="font-headline text-card-foreground">Quick Farm Actions</CardTitle>
          </CardHeader>
